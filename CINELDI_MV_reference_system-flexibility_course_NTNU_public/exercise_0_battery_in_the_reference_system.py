...
path_data_set         = r'C:\Users\Ingrid\PycharmProjects\TET4565_fordypningsemne\CINELDI_MV_reference_system_v_DATA_2023-03-06'
...
# TASK 3:
pp.create_load_from_cosphi(net, bus=95, sn_mva=1, cos_phi=0.95, mode="underexcited")

# TASK 4:
#pp.create_load(net, bus=94, p_mw=-1.5)

# TASK 5:
#pp.create_load(net, bus=94, p_mw=-0.93)

# TASK 6:
pp.create_load(net, bus=94, p_mw=-0.8, q_mvar=-0.2)
...
print("V min: ",net.res_bus.vm_pu.min())
